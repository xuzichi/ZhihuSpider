...
class ZhihuAccount(object):
    ...
    def __init__(self, username: str = None, password: str = None):
        ...
        self.session.cookies = cookiejar.MozillaCookieJar(filename='./cookies.txt')
    ...
    def check_login(self):
        ...
        resp = self.session.get(login_url, allow_redirects=False, verify=False)
